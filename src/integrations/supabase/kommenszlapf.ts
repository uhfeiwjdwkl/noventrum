...
/**
 * Client for the shared Kommenszlapf backend (auth + cross-app profiles).
 * Separate from the generated Lovable Cloud client in ./client, which is used
 * for Noventrum's own database tables.
 */
export const kommenszlapf: SupabaseClient = createClient(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, {
  auth: {
